...
pretrained = 'pretrained/EMOv2_5M_224.pth'  # noqa
lang_model_name = 'bert-base-uncased'

model = dict(
    type='SYGroundingDINO',
    num_queries=900,
    ...
    backbone=dict(
        ...
        sync_bn=False, out_indices=(2, 3, 4), pretrained=pretrained, frozen_stages=-1, norm_eval=True,),
    neck=dict(
        type='ChannelMapper',
        in_channels=[72, 160, 288],
        kernel_size=1,
        out_channels=256,
        act_cfg=None,
        bias=True,
...
work_dir = './work_dirs/grounding_dino_emo-v2_bs64_0409'
